/*
 * Barber Hub PWA — cache 1.9.0 — Operação & Crescimento
 * Network-first para conteúdo; API nunca é armazenada. A experiência instalada
 * inicia na interface HTML dedicada em /mobile.
 */
const CACHE = 'barberhub-v1.9.0-operation-r2';
const CORE_SOURCE = [
  './', './index.html', './offline.html', './mobile/index.html',
  './css/framework.css', './css/global.css', './css/pages.css', './css/index.css', './css/mobile-app.css', './css/release-1.4.1.css', './css/product-redesign.css', './css/release-1.6.css', './css/release-1.7.css', './css/release-1.7.1.css', './css/release-1.8.css', './css/release-1.9.css', './css/brand-assets-1.8.css', './css/mobile-redesign-1.8.css', './css/image-editor.css',
  ...
  './js/cliente.js', './js/painel.js', './js/painel-operacao-1.9.js', './js/admin.js', './js/admin-assinaturas.js', './js/contato.js', './js/mobile-shell-v1.7.js', './js/mobile-native-v1.7.1.js', './js/mobile-redesign-1.8.js', './js/image-editor.js', './js/mobile-home-v1.6.js',
