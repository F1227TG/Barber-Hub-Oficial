/*
 * Barber Hub PWA — cache 1.11 — confiabilidade, privacidade e fechamento
 * Network-first para conteúdo; API nunca é armazenada. A experiência instalada
 * inicia na interface HTML dedicada em /mobile.
 */
const CACHE = 'barberhub-v1.11.0-mobile-r2';
const CORE_SOURCE = [
  './', './index.html', './offline.html', './mobile/index.html',
  './css/framework.css', './css/global.css', './css/pages.css', './css/index.css', './css/mobile-app.css', './css/release-1.4.1.css', './css/product-redesign.css', './css/release-1.6.css', './css/release-1.7.css', './css/release-1.7.1.css', './css/release-1.8.css', './css/release-1.9.css', './css/release-1.9.3.css', './css/releases/release-1.10.css', './css/releases/release-1.11.css', './css/brand-assets-1.8.css', './css/mobile-redesign-1.8.css', './css/image-editor.css',
  './vendor/bootstrap.min.css', './vendor/bootstrap.bundle.min.js',
  './js/utils.js', './js/core/continuation.js', './js/core/operation-draft.js', './js/core/view-state.js', './js/notification-center.js', './js/toast.js', './js/supabase-config.js', './js/supabase-client.js', './js/security.js', './js/backend-api.js',
  ...
  './html/admin.html', './html/admin-assinaturas.html', './html/agendamento.html', './html/barbearia.html', './html/beauty-hub.html', './html/cadastro-barbearia.html', './html/cadastro.html', './html/cliente.html', './html/conta.html', './html/contato.html', './html/login.html', './html/notificacoes.html', './html/painel.html', './html/planos.html', './html/portal.html', './html/privacidade.html', './html/recuperar-senha.html', './html/redefinir-senha.html', './html/servicos.html', './html/sobre.html', './html/termos.html',
  './mobile/admin.html', './mobile/admin-assinaturas.html', './mobile/agendamento.html', './mobile/barbearia.html', './mobile/beauty-hub.html', './mobile/cadastro-barbearia.html', './mobile/cadastro.html', './mobile/cliente.html', './mobile/conta.html', './mobile/contato.html', './mobile/login.html', './mobile/notificacoes.html', './mobile/painel.html', './mobile/planos.html', './mobile/portal.html', './mobile/privacidade.html', './mobile/recuperar-senha.html', './mobile/redefinir-senha.html', './mobile/servicos.html', './mobile/sobre.html', './mobile/termos.html',
