...
def main() -> int:
    ...
    if "barberhub-v1.8.2" not in sw:
        errors.append("service-worker.js não usa o cache barberhub-v1.8.2")
    ...
    for migration_name in ["14_api_python_agendamento_multisservicos.sql", "15_marketplace_fts_api_seguranca.sql", "16_assinaturas_entitlements_beneficios.sql", "17_correcao_auditoria_seguranca.sql"]:
