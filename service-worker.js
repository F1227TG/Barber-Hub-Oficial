/*
 * Barber Hub PWA — cache 1.7.0
 * Network-first para conteúdo; API nunca é armazenada. A experiência instalada
 * inicia na interface HTML dedicada em /mobile.
 */
const CACHE = 'barberhub-v1.7.0';
const CORE = [
  './', './index.html', './offline.html', './mobile/index.html',
  './css/framework.css', './css/global.css', './css/pages.css', './css/index.css', './css/mobile-app.css', './css/release-1.4.1.css', './css/product-redesign.css', './css/release-1.6.css', './css/release-1.7.css',
  ...
  './js/cliente.js', './js/painel.js', './js/admin.js', './js/contato.js', './js/mobile-shell-v1.7.js', './js/mobile-home-v1.6.js',
