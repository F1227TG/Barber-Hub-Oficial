/** Auditoria 1.7.1: caminhos mobile estáticos + dinâmicos + navegação em JS. */
...
console.log(`Roteamento mobile 1.7.1: ${cases.length} casos dinâmicos + ${mobileFiles.length} páginas + navegação JS aprovados.`);
