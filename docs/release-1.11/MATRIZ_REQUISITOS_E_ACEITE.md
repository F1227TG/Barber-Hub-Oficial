...
| E14 | P0 | Agenda online / entitlement | CTA público e configuração profissional usam o entitlement efetivo; Gratuito pode anunciar agenda básica somente após ativação explícita do barbeiro; agenda desligada, estabelecimento indisponível e falha de validação não anunciam nem aceitam agendamento; recursos avançados seguem bloqueados conforme fonte canônica | Gratuito, quatro estados de assinatura, agenda ligada/desligada e falha de RPC/API | Não executado |
