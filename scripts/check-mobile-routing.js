/** Auditoria 1.7.4: caminhos mobile estáticos + dinâmicos + navegação em JS. */
...
console.log(`Roteamento mobile 1.7.4: ${cases.length} casos dinâmicos + ${mobileFiles.length} páginas + navegação JS aprovados.`);
