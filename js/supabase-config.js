...
/*
 * Cloudflare Turnstile (opcional, recomendado antes do lançamento público).
 * Site key é pública e pode ficar no navegador. A secret key NUNCA deve estar
 * aqui; ela é configurada somente no painel do Supabase/Cloudflare.
 */
const BH_TURNSTILE_SITE_KEY = "";
