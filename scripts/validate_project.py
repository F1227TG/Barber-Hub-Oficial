...
def main() -> int:
    ...
    if "barberhub-v1.8.0" not in sw:
        errors.append("service-worker.js não usa o cache barberhub-v1.8.0")
    ...
    for migration_name in ["14_api_python_agendamento_multisservicos.sql", "15_marketplace_fts_api_seguranca.sql", "16_assinaturas_entitlements_beneficios.sql"]:
