...
(() => {
  ...
  const PAGINAS = {
    index: ["Início", "Descubra e gerencie"],
    portal: ["Explorar", "Encontre perto de você"],
    barbearia: ["Estabelecimento", "Serviços e avaliações"],
    agendamento: ["Agendar", "Escolha seu horário"],
    cliente: ["Minha área", "Agenda e favoritos"],
    painel: ["Meu negócio", "Gestão rápida"],
    admin: ["Administração", "Controle da plataforma"],
    ...
    contato: ["Suporte", "Fale com a equipe"],
