...
const CORE_SOURCE = [
  ...
  './js/cliente.js', './js/painel.js', './js/admin.js', './js/admin-assinaturas.js', './js/contato.js', './js/mobile-shell-v1.7.js', './js/mobile-native-v1.7.1.js', './js/mobile-redesign-1.8.js', './js/image-editor.js', './js/mobile-home-v1.6.js',
